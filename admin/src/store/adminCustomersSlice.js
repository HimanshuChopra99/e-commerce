...
export const fetchAdminCustomers = createAsyncThunk('adminCustomers/list', async (params, { rejectWithValue }) => {
  try {
...
export const fetchAdminCustomerById = createAsyncThunk('adminCustomers/getOne', async (id, { rejectWithValue }) => {
  try {
...
const adminCustomersSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchAdminCustomers.pending, (s) => { s.loading = true })

...
export const fetchOverview = createAsyncThunk('adminDashboard/overview', async (_, { rejectWithValue }) => {
  try {
...
export const fetchSalesChart = createAsyncThunk('adminDashboard/salesChart', async (period, { rejectWithValue }) => {
  try {
...
export const fetchRecentOrders = createAsyncThunk('adminDashboard/recentOrders', async (limit, { rejectWithValue }) => {
  try {
...
export const fetchTopProducts = createAsyncThunk('adminDashboard/topProducts', async (limit, { rejectWithValue }) => {
  try {
...
const adminDashboardSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchOverview.pending, (s) => { s.loading = true })

...
export function setPageState(userId, info = {}) {
  ...
  pageStates.set(String(userId), {
    ...
    filters:        info.filters !== undefined ? info.filters : (current.filters || null),
    productDetails: info.productDetails !== undefined ? info.productDetails : (current.productDetails || null),
    cartSummary:    info.cartSummary !== undefined ? info.cartSummary : (current.cartSummary || null),
    lastAction:     info.lastAction !== undefined ? info.lastAction : (current.lastAction || 'Navigated page'),

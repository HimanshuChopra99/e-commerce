...
import { authenticateDeliveryPartner, requireDeliveryPartner } from '../middlewares/delivery-partner-auth.js'
...
router.post('/orders/:orderId/deliver', authenticateDeliveryPartner, requireDeliveryPartner, controller.markDelivered)

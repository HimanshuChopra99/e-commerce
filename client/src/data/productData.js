export const MAIN_PRODUCT = {
  ...
  specs: [
    { label: 'Closure', value: 'Lace closure' },
    {
      label: 'Upper',
      value:
        'adidas PRIMEKNIT textile upper containing at least 50% Parley Ocean Plastic',
    },
    {
      label: 'Midsole',
      value:
        '3D-printed 4DFWD lattice midsole redirecting impact into forward momentum',
    },
    {
      label: 'Outsole',
      value: 'Continental\u2122 Rubber outsole for maximum traction',
    },
  ...
  highlights: [
    {
      ...
      description:
        'Compresses forward upon impact, reducing braking force and transforming impact energy into forward motion.',
      icon: 'Cpu',
    },
    {
      title: 'Parley Ocean Plastic',
      description:
        'Upper yarn made with at least 50% Parley Ocean Plastic intercepted on remote islands, beaches, and coastal communities.',
      icon: 'Waves',
    },
    {
      title: 'Continental\u2122 Traction',
      description:
        'Extraordinary grip in wet and dry conditions engineered for street and track surfaces.',
      icon: 'Zap',
    },
  ],
};
export const REVIEWS_DATA = [
  {
    ...
    content:
      'The 3D-printed lattice sole looks futuristic and actually feels like it propels you forward with every stride. The Parley ocean plastic knit upper is ultra breathable and fits like a glove.',
  ...
  },
  {
    ...
    content:
      'Bought these for both gym sessions and urban street style outfits. Color pattern in real life is even richer than photos. Getting compliments everywhere.',
    colorway: 'Shadow Navy / Army Green',
    sizeBought: '38',
    fitFeedback: 'True to Size',
    helpfulCount: 18,
  },
  {
    ...
    content:
      'Takes about 1-2 short runs to break in the primeknit fit around the collar, but once set, the dampening on hard asphalt is second to none.',

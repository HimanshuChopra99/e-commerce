...
export const SEED_PRODUCTS: NewProduct[] = [
  // ==================== MEN'S SNEAKERS ====================
  {
    ...
    reviewsCount: 142,
    description:
      'Engineered for street resilience and ultimate responsive air cushioning.',
  },
  {
    name: 'Retro High OG',
    brand: 'Jordan',
    ...
    reviewsCount: 310,
    description:
      'The timeless high-top silhouette that defined sneaker culture.',
  },
  {
    ...
    reviewsCount: 89,
    description:
      'Clean heritage styling with soft garment leather and plush EVA foam.',
  },
  {
    ...
    reviewsCount: 204,
    description:
      'The iconic skate shoe featuring the legendary sidestripe and waffle outsole.',
  },
  {
    ...
    reviewsCount: 165,
    description:
      'Our lightest BOOST ever, designed with incredible energy return for daily runs.',
  },
  {
    ...
    reviewsCount: 54,
    description:
      'Built for quick cuts, stop-on-a-dime traction, and explosive speed on the hardwood.',
  },
  {
    name: 'Air Max 97 OG',
    brand: 'Nike',
    ...
    reviewsCount: 412,
    description:
      'Inspired by Japanese bullet trains with full-length visible air cushioning.',
  },
  {
    name: 'NB 550 Vintage',
    brand: 'New Balance',
    ...
    reviewsCount: 93,
    description:
      'The retro hoop classic revived for everyday street aesthetics.',
  },
  {
    name: 'Dunk Low Retro',
    brand: 'Nike',
    ...
    reviewsCount: 520,
    description:
      'Crisp leather overlays and heritage color blocking for everyday wear.',
  },
  {
    ...
    reviewsCount: 68,
    description:
      'All-terrain confidence with rugged traction and React foam cushioning.',
  },
  ...
  // ==================== WOMEN'S SNEAKERS ====================
  {
    ...
    reviewsCount: 198,
    description:
      'Fastbreak retro style of 1980s basketball meets the fast-paced culture of today.',
  },
  {
    name: 'Solar Glide 6',
    brand: 'Adidas',
    ...
    reviewsCount: 154,
    description:
      'Daily distance runners with LEP 2.0 torque guidance and plush BOOST comfort.',
  },
  {
    ...
    reviewsCount: 77,
    description:
      'Agile training silhouette with breathable mesh and stabilized heel counter.',
  },
  {
    name: 'Blazer Mid 77',
    brand: 'Nike',
    ...
    reviewsCount: 340,
    description:
      'Old-school basketball look that delivers timeless comfort and vintage flair.',
  },
  {
    name: 'Samba OG White',
    brand: 'Adidas',
    ...
    reviewsCount: 610,
    description:
      'Born on the pitch, standing icon of street fashion with T-toe suede overlay.',
  },
  {
    name: 'Metcon 9 Women',
    brand: 'Nike',
    ...
    reviewsCount: 112,
    description:
      'Wider Hyperlift plate and rubber rope wrap for intense gym and CrossFit workouts.',
  },
  {
    ...
    reviewsCount: 228,
    description:
      'Quick-dry bandage strap with pillowy Cloudfoam footbed for post-workout recovery.',
  },
  {
    ...
    reviewsCount: 285,
    description:
      'Playful twist on a classic hoop design featuring layered details and doubled branding.',
  },
  {
    ...
    reviewsCount: 88,
    description:
      'Race-day speed machine with carbon-fiber Flyplate and high-stack ZoomX foam.',
  },
  {
    ...
    reviewsCount: 190,
    description:
      'Premium craftsmanship with heavier canvas, extra cushioning, and glossy midsole.',
  },
];

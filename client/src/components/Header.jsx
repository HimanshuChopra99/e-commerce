...
export const Header = ({
  ...
  return (
    <header className="sticky top-0 z-40 w-full pt-3 pb-2 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-neutral-200/80 px-4 sm:px-6 py-3 flex items-center justify-between transition-all duration-200">
        ...
        <nav className="hidden md:flex items-center space-x-6 text-sm font-semibold text-neutral-900">
          ...
          >
            ...
            {activeDropdown === 'men' && (
              <div className="absolute top-full left-0 mt-1 w-48 bg-white rounded-xl shadow-xl border border-neutral-100 py-2 z-50 animate-in fade-in slide-in-from-top-1 duration-150">
                <a
                  href="#running"
                  className="block px-4 py-2 text-xs hover:bg-neutral-50 text-neutral-700 hover:text-blue-600 font-medium"
                >
                  Running Shoes
                </a>
                <a
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden mt-2 bg-white rounded-2xl p-4 shadow-xl border border-neutral-200 animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="space-y-3 font-semibold text-neutral-800">
            ...
            <a href="#men" className="block p-2 rounded-lg hover:bg-neutral-50">
              Men's Collection
            </a>
            <a
              href="#women"
              className="block p-2 rounded-lg hover:bg-neutral-50"
            >
              Women's Collection
            </a>
            <a

...
export const ReviewsSection = ({
  ...
  return (
    <section className="my-12 bg-white rounded-3xl p-6 sm:p-10 border border-neutral-200/80 shadow-xs space-y-8">
      {/* Header */}
              ...
              >
                ...
                <div className="flex-1 bg-neutral-200 h-2.5 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${stars === 5 ? 85 : stars === 4 ? 15 : 0}%`,
                    }}
                  />
                </div>
                <span className="w-10 text-left text-neutral-500">
        ...
        <div className="md:col-span-7 flex flex-col justify-center space-y-3 md:border-l md:border-neutral-200 md:pl-8">
          ...
          <div className="grid grid-cols-3 gap-3 text-center text-xs font-semibold">
            <div className="p-3 bg-white rounded-xl border border-neutral-200">
              <span className="block text-neutral-400 text-[10px] uppercase">
                Runs Small
              </span>
              <span className="text-neutral-900 font-extrabold">2%</span>
            </div>
            <div className="p-3 bg-blue-50 border border-blue-200 rounded-xl text-blue-900">
              <span className="block text-blue-600 text-[10px] uppercase">
                True to Size
              </span>
        ...
        {filtered.map((rev) => (
          ...
          >
            ...
            <div className="pt-2 flex items-center justify-between text-[11px] text-neutral-500 font-medium">
              <span>
                Fit:{' '}
                <strong className="text-neutral-800">{rev.fitFeedback}</strong>
              </span>
      ...
      {writeModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-neutral-200 relative">
            ...
            <h3 className="font-extrabold text-lg uppercase text-neutral-900 mb-4">
              ...
              <div>
                ...
                <div className="flex gap-2 text-amber-400">
                  {[1, 2, 3, 4, 5].map((s) => (
                    ...
                    >
                      <Star
                        className={`w-6 h-6 ${s <= newRating ? 'fill-amber-400 text-amber-400' : 'text-neutral-300'}`}
                      />
                    </button>
                  ))}
                </div>

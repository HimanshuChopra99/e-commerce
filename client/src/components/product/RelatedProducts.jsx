      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-neutral-500 font-medium">
            Recommended performance running & street footwear
          </p>
        </div>
        ...
        <button
          type="button"
          onClick={onViewAll}
          className="text-xs font-extrabold uppercase tracking-wider text-[#4A69E2] hover:underline flex items-center gap-1 cursor-pointer"
        >
          ...
          >
            <div>
              ...
              >
                ...
                {item.tag && (
                  <span className="absolute top-2.5 left-2.5 bg-[#4A69E2] text-white text-[10px] font-bold px-2.5 py-1 rounded-lg">
                    {item.tag}
                  </span>
                )}

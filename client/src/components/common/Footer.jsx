...
function NewsletterSection() {
  ...
  const [msg, setMsg] = useState({ text: "", color: "#ffffff", visible: false });
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-9 lg:gap-8">
          ...
          <Reveal className="max-w-xl" delay={0}>
            <h2 className="text-white font-bold uppercase leading-[1.14] tracking-tight text-[25px] sm:text-4xl lg:text-[40px] xl:text-[44px]">
              Join our KicksPlus<br className="hidden sm:block" /> Club &amp; Get 15% Off
            </h2>
            ...
            <form onSubmit={handleSubmit} noValidate
              ...
              <input
                ref={emailRef}
                type="email" required autoComplete="email" aria-label="Email address"
          ...
          {/* Right — KICKS logo */}
          <Reveal className="self-start lg:self-center lg:pr-4 xl:pr-8" delay={70}>
            <div className="logo-wrap relative inline-block select-none cursor-default">
              ...
              <span className="logo-badge absolute -top-1.5 -right-4 sm:-right-5 lg:-right-6 w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 rounded-full bg-[#FFA52F] flex items-center justify-center">
                <svg viewBox="0 0 24 24" className="w-3 h-3 sm:w-3.5 sm:h-3.5" fill="none"
                  stroke="#232321" strokeWidth="3.4" strokeLinecap="round">
...
function LinksSection() {
  ...
  return (
    <section className="relative z-20 -mt-6 sm:-mt-8 lg:-mt-10 bg-[#232321] rounded-t-[28px] sm:rounded-t-[36px] lg:rounded-t-[44px] overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-5 sm:px-10 lg:px-[72px] pt-10 sm:pt-12 lg:pt-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-x-8 gap-y-10 lg:gap-x-6">
          ...
          <Reveal className="sm:col-span-2 lg:col-span-5" delay={0}>
            <h3 className="text-[#FFA52F] font-semibold text-lg lg:text-[22px] mb-3 lg:mb-4">About us</h3>
      ...
      {/* Giant wordmark */}
      <Reveal className="mt-10 sm:mt-12 lg:mt-16 select-none pointer-events-none" delay={280}>
        <div aria-hidden="true">
          <svg viewBox="0 0 1000 150" className="w-full block" preserveAspectRatio="xMidYMin meet">
            <text x="500" y="212" textAnchor="middle"
              fontFamily="Rubik, sans-serif" fontWeight="900" fontSize="292"
              fill="#ffffff" textLength="992" lengthAdjust="spacing">
              KICKS
            </text>
          </svg>
        </div>
...
export default function Footer() {
  ...
  useEffect(() => {
    ...
    return () => { /* leave styles; safe for SPA reuse */ };
  }, []);

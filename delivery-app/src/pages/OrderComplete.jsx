...
export default function OrderComplete() {
  ...
  const orderNumber =
    order?.orderNumber ||
    order?.order_number ||
    (order?.id ? String(order.id).replace('#', '') : '1001');
  const customerName =
    order?.customerName ||
    order?.customer ||
  ...
  const pickupLabel =
    order?.pickupAddress || order?.pickup?.label || 'KICKS Main Hub';
      ...
      <div className="flex-1 flex flex-col justify-center gap-4 my-auto">
        ...
        <div className="flex flex-col items-center text-center pt-2">
          ...
          >
            <Icon
              name="check_circle"
              fill
              className="text-[14px] text-emerald-600 dark:text-emerald-400"
            />
        ...
        <div
          ...
          style={{
            ...
            background:
              'linear-gradient(135deg, #6b38d4 0%, #7c43ea 50%, #9a6bff 100%)',
          }}
        >
        ...
        >
          {stats.map((s) => (
            ...
            >
              ...
              <span
                className={`text-body-md font-bold tracking-tight tabular-nums ${s.accent ? 'text-primary' : 'text-on-surface'}`}
              >
                {s.value}
              </span>
          ...
          <div className="relative pl-7 py-0.5">
            ...
            <div className="relative mb-4">
              ...
              <div className="flex flex-col min-w-0">
                ...
                <span className="text-label-sm text-on-surface-variant truncate mt-0.5">
                  {pickupAddress}
                </span>
              </div>
            </div>

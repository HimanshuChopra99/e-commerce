...
export default function CompletionOverlay() {
  return (
    <div
      className="fixed inset-0 z-[3000] flex items-center justify-center anim-comp-fade"
      style={{ background: 'rgba(248,249,250,0.96)' }}
    >
      {/* Expanding rings */}
      <div className="relative flex items-center justify-center">
        ...
        <div className="relative w-28 h-28 rounded-full bg-gradient-to-br from-primary to-[#9a6bff] shadow-2xl shadow-primary/40 flex items-center justify-center anim-comp-pop">
          <Icon
            name="check"
            fill
            className="text-white anim-comp-check"
            style={{ fontSize: '56px' }}
          />
        </div>
      ...
      <div className="absolute bottom-[24%] left-0 right-0 text-center px-6">
        <p className="text-headline-lg text-on-surface font-bold anim-comp-up">
          Delivery Complete!
        </p>
